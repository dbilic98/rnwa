<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            <div class="col-md" >
                <h2 class="card-title mb-4">Edit a employee</h2>
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo e(route('employee.update',$employee->id)); ?>" class="form-control mx-auto border-0"  method="POST">
                            ...
                            <select class="form-select" name="branch_id" >
                                <option value="">Pick the branch</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5.2\resources\views/employee/edit.blade.php ENDPATH**/ ?>